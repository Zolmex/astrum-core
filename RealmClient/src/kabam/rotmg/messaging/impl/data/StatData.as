...
public class StatData {
    ...
    public static const OXYGEN_STAT:int = 58;
    ...
    public static const INVENTORYDATA_0_STAT:int = 71;
    public static const INVENTORYDATA_1_STAT:int = 72;
    public static const INVENTORYDATA_2_STAT:int = 73;
    public static const INVENTORYDATA_3_STAT:int = 74;
    public static const INVENTORYDATA_4_STAT:int = 75;
    public static const INVENTORYDATA_5_STAT:int = 76;
    public static const INVENTORYDATA_6_STAT:int = 77;
    public static const INVENTORYDATA_7_STAT:int = 78;
    public static const INVENTORYDATA_8_STAT:int = 79;
    public static const INVENTORYDATA_9_STAT:int = 80;
    public static const INVENTORYDATA_10_STAT:int = 81;
    public static const INVENTORYDATA_11_STAT:int = 82;
    public static const INVENTORYDATA_12_STAT:int = 83;
    public static const INVENTORYDATA_13_STAT:int = 84;
    public static const INVENTORYDATA_14_STAT:int = 85;
    public static const INVENTORYDATA_15_STAT:int = 86;
    public static const INVENTORYDATA_16_STAT:int = 87;
    public static const INVENTORYDATA_17_STAT:int = 88;
    public static const INVENTORYDATA_18_STAT:int = 89;
    public static const INVENTORYDATA_19_STAT:int = 90;
